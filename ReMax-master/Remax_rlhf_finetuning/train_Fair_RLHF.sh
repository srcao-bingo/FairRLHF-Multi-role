...
ACTOR_MODEL_PATH="${BASE_PATH}/llama2-7b-sft"
REWARD_MODEL_PATH="${BASE_PATH}/llama2-7b-rm"
ACTOR_ZERO_STAGE=2
REWARD_ZERO_STAGE=3
...
if [ "$OUTPUT" == "" ]; then
    ...
    OUTPUT="/home/${USERNAME}/log/step3_remax_FairRLHF_llama2_7b_hf-${DATA_PATH}-$TIME_STEP-$SEED"
fi
